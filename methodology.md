...
1. Downloaded data sources:
  	...
  	6. Ecology of Manhattan in 1609
  	    ...
  	    2. The primary datafile of interest was the ecocomm raster file. This was saved in the format of an ESRI grid file. I opened it in ArcMap to download the attribute table.
...
3.   Statistical analysis
      1. I used a logistic regression (see [02_analysis.py](https://github.com/jennahgosciak/nycflood/blob/main/02_analysis.py)) to estimate how well the 1609 ecology predicates flooding risk. I did this for both the FEMA 100-year floodplain and for the moderate risk of flooding due to rainfall.
      ...
      3. I then merged performed several spatial joins to existing polygon data (for ease of processing, I did this in Python).
          ...
          2. I merged to the moderate risk of flooding polygon file (with a 15-foot buffer) using a spatial join with intersects.
